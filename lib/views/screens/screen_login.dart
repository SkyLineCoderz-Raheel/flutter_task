              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    CustomText(text: "Login to your Account",
                      size: 22,
                    ...
                    Row(
                      children: <Widget>[
                        Obx(() {
                          return Checkbox(value: controllerLogin.check.value,
                              onChanged: (value) {
                                controllerLogin.check.value = value!;
                              });
                        }),
                        Text("Remember me ",style: TextStyle(color: Color(0xFF6E6B7B)),),
                        Spacer(),
                    ...
                    MyCustomButton(text: "Login", onTap: () {
